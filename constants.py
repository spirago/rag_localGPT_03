...
# => (org setting) EMBEDDING_MODEL_NAME = "hkunlp/instructor-large"  # Uses 1.5 GB of VRAM (High Accuracy with lower VRAM usage)
...
# => (org setting) MODEL_ID = "TheBloke/Llama-2-7b-Chat-GGUF"
# => (org setting) MODEL_BASENAME = "llama-2-7b-chat.Q4_K_M.gguf"
